...
!function(e, t) {
  ...
  var e, s = (function (t) { function e() { return { baseUrl: null, breaks: !1, gfm: !0, headerIds: !0, headerPrefix: '', highlight: null, langPrefix: 'language-', mangle: !0, pedantic: !1, renderer: null, sanitize: !1, sanitizer: null, silent: !1, smartLists: !1, smartypants: !1, xhtml: !1 } } t.exports = { defaults: e(), getDefaults: e, changeDefaults: function (e) { t.exports.defaults = e } } }(e = { exports: {} }, e.exports), e.exports), i = (s.defaults, s.getDefaults, s.changeDefaults, /[&<>"']/), l = /[&<>"']/g, a = /[<>"']|&(?!#?\w+;)/, o = /[<>"']|&(?!#?\w+;)/g, h = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', '\'': '&#39;' };
  ...
  function x(e, t) {
    d[' ' + e] ||
        (k.test(e) ? d[' ' + e] = e + '/' : d[' ' + e] = _(e, '/', !0));
    var n = -1 === (e = d[' ' + e]).indexOf(':');
    return '//' === t.substring(0, 2) ?
        n ? t : e.replace(b, '$1') + t :
        '/' === t.charAt(0) ? n ? t : e.replace(m, '$1') + t : e + t
  }
  function _(e, t, n) {
    var r = e.length;
    if (0 === r) return '';
  ...
  }, Z = {exec: function() {}}, L = function(n, e) {
    n = n.source || n, e = e || '';
    var r = {
  ...
  C.def =
      L(C.def).replace('label', C._label).replace('title', C._title).getRegex(),
  C.bullet = /(?:[*+-]|\d{1,9}\.)/,
  C.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/,
  C.item = L(C.item, 'gm').replace(/bull/g, C.bullet).getRegex(),
  C.list =
      L(C.list)
  ...
  C.paragraph =
      L(C._paragraph)
          ...
          .replace('tag', C._tag)
          .getRegex(),
  C.blockquote = L(C.blockquote).replace('paragraph', C.paragraph).getRegex(),
  C.normal = q({}, C),
  C.gfm = q({}, C.normal, {
    nptable:
        /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
  ...
  C.pedantic = q({}, C.normal, {
    ...
    heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
    fences: Z,
    paragraph: L(C.normal._paragraph)
                   .replace('hr', C.hr)
                   .replace('heading', ' *#{1,6} *[^\n]')
  ...
  O.em = L(O.em).replace(/punctuation/g, O._punctuation).getRegex(),
  O._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
  O._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,
  O._email =
      /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,
  O.autolink = L(O.autolink)
  ...
  O.link = L(O.link)
               ...
               .getRegex(),
  O.reflink = L(O.reflink).replace('label', O._label).getRegex(),
  O.normal = q({}, O),
  O.pedantic = q({}, O.normal, {
    strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,
    em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,
    link: L(/^!?\[(label)\]\((.*?)\)/).replace('label', O._label).getRegex(),
    reflink:
        L(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace('label', O._label).getRegex()
  }),
  O.gfm = q({}, O.normal, {
  ...
  O.gfm.url =
      L(O.gfm.url, 'i').replace('email', O.gfm._extended_email).getRegex(),
  O.breaks = q({}, O.gfm, {
  ...
  var D = {block: C, inline: O}, E = s.defaults, j = D.block, P = z, T = S,
      I = y,
      B =
          function() {
        function n(e) {
          this.tokens = [], this.tokens.links = Object.create(null),
          this.options = e || E, this.rules = j.normal,
          ...
          return e = e.replace(/\r\n|\r/g, '\n').replace(/\t/g, '    '),
               ...
               e.token =
                 ...
                 for (e = e.replace(/^ +$/gm, ''); e;)
                   if ((s = this.rules.newline.exec(e)) &&
                     ...
                     m&& 'paragraph' === m.type ?
                         m.text += '\n' + s[0].trimRight() :
                         (s = s[0].replace(/^ {4}/gm, ''), this.tokens.push({
                           type: 'code',
                     ...
                     e = e.substring(s[0].length),
                     this.tokens.push(
                         {type: 'heading', depth: s[1].length, text: s[2]});
                   else if (
                     ...
                     for (e = e.substring(s[0].length), p = 0;
                          p < a.align.length; p++)
                       / ^ * -+: * $ /.test(a.align[p]) ?
                           a.align[p] = 'right' :
                           /^ *:-+: *$/.test(a.align[p]) ?
                           a.align[p] = 'center' :
                           /^ *:-+ *$/.test(a.align[p]) ? a.align[p] = 'left' :
                                                          a.align[p] = null;
                     ...
                     s = s[0].replace(/^ *> ?/gm, ''), this.token(s, t),
                     ...
                     for (e = e.substring(s[0].length), o = {
                         ...
                         this.tokens.push(o), n = !(h = []),
                         f = (s = s[0].match(this.rules.item)).length, p = 0;
                          p < f; p++)
                       c = (a = s[p]).length,
                       ~(a = a.replace(/^ *([*+-]|\d+\.) */, ''))
                               .indexOf('\n ') &&
                       ...
                       h.push(u), this.tokens.push(u), this.token(a, !1),
      ...
      X =
        ...
        return t.code = function(e, t, n) {
          ...
          return r ? '<pre><code class="' + this.options.langPrefix + N(r, !0) +
                  '">' + (n ? e : N(e, !0)) + '</code></pre>\n' :
          ...
          return this.options.headerIds ?
              '<h' + t + ' id="' + this.options.headerPrefix + r.slug(n) +
                  '">' + e + '</h' + t + '>\n' :
              '<h' + t + '>' + e + '</h' + t + '>\n'
        }, t.hr = function() {
      ...
      G =
        ...
        return e.prototype.slug = function(e) {
          ...
          if (this.seen.hasOwnProperty(t))
            for (var n = t; this.seen[n]++, t = n + '-' + this.seen[n],
                     this.seen.hasOwnProperty(t);)
              ;
          return this.seen[t] = 0, t
        }, e
      }(),
      M = s.defaults, V = D.inline, H = A, J = y,
      K =
          function() {
        function u(e, t) {
          if (this.options = t || M, this.links = e, this.rules = V.normal,
          ...
          this.options.pedantic ? this.rules = V.pedantic :
                                  this.options.gfm &&
                  (this.options.breaks ? this.rules = V.breaks :
                                         this.rules = V.gfm)
        }
          ...
          for (var t, n, r, s, i, l, a = ''; e;)
            if (i = this.rules.escape.exec(e))
              ...
              !this.inLink && /^<a /i.test(i[0]) ?
                  ...
                  a += this.options.sanitize ? this.options.sanitizer ?
              ...
              if (-1 < o) {
                ...
                i[2] = i[2].substring(0, o), i[0] = i[0].substring(0, h).trim(),
                i[3] = ''
              }
              e = e.substring(i[0].length), this.inLink = !0, r = i[2],
              ...
              a +=
                  this.outputLink(i, {href: u.escapes(r), title: u.escapes(s)}),
              this.inLink = !1
            } else if (
              ...
              e = e.substring(i[0].length),
              r = '@' === i[2] ? 'mailto:' + (n = J(this.mangle(i[1]))) :
                                 n = J(i[1]),
              ...
              if (i = this.rules.text.exec(e))
                ...
                this.inRawBlock ?
                    a += this.renderer.text(
                        this.options.sanitize ? this.options.sanitizer ?
                                                this.options.sanitizer(i[0]) :
                                                J(i[0]) :
                                                i[0]) :
              ...
              if ('@' === i[2])
                ...
                for (; l = i[0], i[0] = this.rules._backpedal.exec(i[0])[0],
                       l !== i[0];)
                  ;
      ...
      te =
          function() {
        function n(e) {
          this.tokens = [], this.token = null, this.options = e || W,
          this.options.renderer = this.options.renderer || new X,
          this.renderer = this.options.renderer,
        ...
        return e.parse = function(e) {
          ...
          this.inlineText =
              new K(e.links, Y({}, this.options, {renderer: new Q})),
          ...
          switch (this.token.type) {
            ...
            case 'heading':
              return this.renderer.heading(
                  ...
                  ee(this.inlineText.output(this.token.text)), this.slugger);
            case 'code':
              return this.renderer.code(
                  this.token.text, this.token.lang, this.token.escaped);
            case 'table':
              var t, n, r, s, i = '';
              ...
              for (i += this.renderer.tablerow(r), t = 0;
                ...
                for (n = this.token.cells[t], r = '', s = 0; s < n.length; s++)
                  r += this.renderer.tablecell(
                      this.inline.output(n[s]),
                      {header: !1, align: this.token.align[s]});
            ...
            case 'list_item_start':
              e = '';
              var o = this.token.loose, h = this.token.checked,
                  u = this.token.task;
              if (this.token.task)
                if (o)
                  if ('text' === this.peek().type) {
                    ...
                    this.tokens.push(
                        {type: 'text', text: this.renderer.checkbox(h)});
                else
                  e += this.renderer.checkbox(h);
              for (; 'list_item_end' !== this.next().type;)
                e += o || 'text' !== this.token.type ? this.tok() :
                                                       this.parseText();
      ...
      ne = $, re = R, se = y, ie = s.getDefaults, le = s.changeDefaults,
      ae = s.defaults;
  function oe(t, l, a) {
    if (null == t)
    ...
    try {
      ...
      if (e.message +=
        ...
        return '<p>An error occurred:</p><pre>' + se(e.message + '', !0) +
            '</pre>';
      throw e
    }
  }
  return oe.options = oe.setOptions =
             function(e) {
    return ne(oe.defaults, e), le(oe.defaults), oe
  },
         oe.getDefaults = ie, oe.defaults = ae, oe.Parser = te,
         oe.parser = te.parse, oe.Renderer = X, oe.TextRenderer = Q,
         oe.Lexer = B, oe.lexer = B.lex, oe.InlineLexer = K,
         oe.inlineLexer = K.output, oe.Slugger = G, oe.parse = oe
});